...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); const item_r9 = ctx.$implicit; const i_r10 = ctx.index; const ctx_r12 = ɵngcc0.ɵɵnextContext(); return ctx_r12.onItemDragstart($event, item_r9, i_r10); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); const ctx_r14 = ɵngcc0.ɵɵnextContext(); return ctx_r14.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); const i_r10 = ctx.index; const ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15.onItemDragover($event, i_r10); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r13); const ctx_r16 = ɵngcc0.ɵɵnextContext(); return ctx_r16.cancelEvent($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r3.itemClass, i_r10 === ctx_r3.activeItem ? ctx_r3.itemActiveClass : ""))("ngStyle", ctx_r3.getItemStyle(i_r10 === ctx_r3.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r10 === ctx_r3.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r3.itemTemplate || _r4)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r9, i_r10));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r17 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r17.value);
} }
